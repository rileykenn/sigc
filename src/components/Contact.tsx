        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          >
            ...
            <a
              ...
              className="group flex items-start gap-4 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-100 transition-all hover:shadow-lg hover:ring-navy-200"
            >
              <div className="rounded-xl bg-navy-50 p-3 text-navy-600 transition-transform group-hover:scale-110 duration-300">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-navy-900 group-hover:text-navy-600 transition-colors">
                  (02) 4441 2259
                </p>
              </div>
            </a>
            ...
            <button
              ...
              className="group flex items-start gap-4 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-100 transition-all hover:shadow-lg hover:ring-navy-200 w-full text-left"
            >
          ...
          <motion.div
            ...
            className="rounded-2xl overflow-hidden shadow-xl shadow-navy-900/5 ring-1 ring-gray-100 min-h-[400px]"
          >
            <iframe
